...
- Phase 4 收尾（人工步驟）：Show HN / r/mcp 發文（草稿 docs/launch/，發文前補實平台支援度佔位、挑候選標題）、收進 terrychou.com 作品集。（已完成：push、repo 本即 public、demo GIF 已自動錄製為 README 主視覺——工具鏈收錄於 scripts/record-gif/，README 已依 soulshard 風格重排。）
